...
public class Scene_02_OverScenePlayback : MonoBehaviour
{
	#region Variables
	...
	void OnGUI()
	{
		...
		if (Scene_00_GUI.Button("Push to\nChange Scene", GUILayout.Width(200), GUILayout.Height(200))) {
			...
			UnityEngine.SceneManagement.SceneManager.LoadScene("Scene_02_OverScenePlaybackSub");
#else
			Application.LoadLevel("Scene_02_OverScenePlaybackSub");
#endif
		}
		GUILayout.EndArea();
